# Generated by Django 4.1.2 on 2024-03-22 11:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='date of user registration', verbose_name='created')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_name', models.CharField(max_length=255, unique=True, verbose_name='collection')),
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=100, verbose_name='price')),
                ('stock_quantity', models.IntegerField(default=10, help_text='available product stock', verbose_name='stock')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='timestamp when the product was added', verbose_name='created')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store_app.product')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
